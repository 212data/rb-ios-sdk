...
class SDKEventProcessorHandlerTest: XCTestCase {
    ...
    func test_it_should_construct_session_start_event_and_make_api_call() {
        let sessionContextHolder = FakeSessionContextHolder().withExtraParameters(["utm_medium": "relevantbox"])
        ...
        let httpService = FakeHttpService(
            ...
            collectorUrl: "https://c.relevantbox.io",
            apiUrl: "https://api.relevantbox.io"
        )
        ...
        XCTAssertTrue("relevantbox" == body["utm_medium"] as! String)
    }
    ...
    func test_it_should_construct_heart_beat_event_and_make_api_call() {
        ...
        let sessionContextHolder = FakeSessionContextHolder().withExtraParameters(["utm_medium": "relevantbox"]).withLastActivityTime(1584558770000)
        let applicationContextHolder = FakeApplicationContextHolder(userDefaults: InitializedUserDefaults())
    ...
    func it_should_invoke_with_nil_heart_beat_event_when_last_event_time_is_not_before_current_time_minus_interval() {
        ...
        let sessionContextHolder = FakeSessionContextHolder().withExtraParameters(["utm_medium": "relevantbox"]).withLastActivityTime(1587237260000)
        let applicationContextHolder = FakeApplicationContextHolder(userDefaults: InitializedUserDefaults())
    ...
    func test_it_should_invoke_with_nil_http_service_when_serializer_service_has_error_on_heart_beat() {
        ...
        let httpService = FakeHttpService(sdkKey: "sdk-key", session: FakeUrlSession(), collectorUrl: "https://c.relevantbox.io", apiUrl: "https://api.relevantbox.io")
        let entitySerializerService = CapturingEntitySerializerService.init()
