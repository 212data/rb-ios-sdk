...
class NotificationProcessorHandlerTest: XCTestCase {
    ...
    func test_it_should_construct_push_opened_event_and_make_api_call() {
        ...
        notificationProcessorHandler.pushMessageOpened(pushContent: ["source": "relevantbox", "pushId": "123123", "campaignId": "campaign", "campaignDate": "campaignDate"])
    ...
    func test_it_should_not_construct_push_opened_event_and_make_api_call_when_source_is_defined_other_than_relevantbox() {
        let httpService = FakeHttpService(
            sdkKey: "sdk-key",
            session: FakeUrlSession(),
            collectorUrl: "https://c.relevantbox.io",
